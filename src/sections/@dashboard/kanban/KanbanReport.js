...
export default function KanbanReport({ isOpenCompose, onCloseCompose }) {
  ...
  return (
    <Portal>
      ...
      >
        ...
        >
          <Typography variant="h6">گزارش جدید</Typography>
          <Box sx={{ flexGrow: 1 }} />
        ...
        {/* <InputStyle disableUnderline placeholder="به" /> */}

        <InputStyle disableUnderline placeholder="عنوان" />
