...
const TASKS = [
  'افزودن گزارش کار جلسه داخلی گروه برای انجام عملیات',
  'افزودن گزارش کار جلسه داخلی',
  ' افزودن گزارش کار جلسه داخلی گروه برای انجام عملیات تستی گروه در حوزه آمل صورت گرفته کار',
  'یادداشت ها',
  'نظافت میزکار',
];
