...
export const _appRelated = ['طراحی رابط کاربری کارا2', 'پشتیبانی پروژه های خلیج...', 'بازنمایی آرایه های ادبی', 'پشتیبانی پروژه های خلیج...', 'درخواست نظافت'].map((appName, index) => ({
  id: _mock.id(index),
  name: appName,
