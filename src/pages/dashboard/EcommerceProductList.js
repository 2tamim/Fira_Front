...
const TABLE_HEAD = [
  { id: 'name', label: 'عنوان', align: 'left' },
  { id: 'createdAt', label: 'زمان ثبت', align: 'left' },
  { id: 'inventoryType', label: 'وضعیت', align: 'center', width: 180 },
  { id: 'price', label: 'نوع درخواست', align: 'right' },
  { id: '' },
];
                    ...
                    .map((data, index) =>
                      data ? (
                        <ProductTableRow
                          ...
                          onSelectRow={() => onSelectRow(data.id)}
                          onDeleteRow={() => handleDeleteRow(data.id)}
                          onEditRow={() => handleEditRow(data.name)}
                        />
                      ) : (
